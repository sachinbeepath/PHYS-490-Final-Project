...
#### stuff Yilda added
our_data = "/Users/yilda/Documents/PHYS490/PHYS-490-Final-Project/Data/2 Qubit/data.txt"
...
class LatentAttention():
    def __init__(self, data, K=4, Number_qubits=6 , latent_rep_size=100, gru_hidden=100,decoder='TimeDistributed_mol', Nsamples=0):
        ...
        dataset_onehot = [onehot_encode(datapoint, self.charset_length, self.max_length) for datapoint in self.data_train]
        self.data_train = dataset_onehot
...
model = LatentAttention(data=our_data, K=4, Number_qubits = int(sys.argv[1]), latent_rep_size=int(sys.argv[2]), gru_hidden=int(sys.argv[3]), decoder='TimeDistributed', Nsamples = int(sys.argv[4]) )
model.train()
